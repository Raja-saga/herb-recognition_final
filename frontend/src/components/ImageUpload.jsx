    ...
    <>
      <div className="upload-section">
        ...
        <div className="upload-box">
          ...
          />
          {!isLocationProvided && (
            <p className="location-warning">⚠️ Location not provided </p>
          )}
        </div>
        ...
        {loading && (
          <div className="loading">
            ...
            {isLocationProvided && <p>• Performing geo-validation</p>}
      ...
      {/* LLM Explanation Section */}
        {result && result.llmExplanation && (
  <div className="llm-section">
    <h3>Medicinal Information (RAG + LLM)</h3>
    <div className="llm-content">
      {result.llmExplanation.split("\n").map((line, index) => (
        <p key={index}>{line}</p>
      ))}
    </div>
  </div>
